...
#'  Note that IDs in the two tables need to conform; e.g., character in both coords_matrix and pairs_table.
#'
...
#'
#' calc_ed(my_data, pairs)
#'
calc_ed <- function(coords_matrix, pairs_table) {
