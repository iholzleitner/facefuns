...
:-------- | :---------------------------------------------------------------------- 
`facefuns2d` | Conducts GPA and PCA, selects and visualizes PCs for 2-D data
`facefuns3d` | Conducts GPA and PCA, selects and visualizes PCs for 3-D data
...
`make_pcs` | Creates coordinates for a reference face at +/- x units of standard deviations for a given (list of) principal component(s) 
