...
This package contains convenience functions for doing shape analyses of 2D and 3D face images in `R`, as well as tutorials for some common analyses (such as calculating averageness, asymmetry, [sexual dimorphism](./calcSD.html) and [facial similarity](./calcED.html)).
